...
//****************************************************
//added function to restart game. resets answer and instructions, but does not make new call to api
let randomNumber = Math.floor((Math.random() * 88) * 1)
let apiUrl = 'https://swapi.co/api/people/' + randomNumber
...
let showAnswer = document.querySelector('#showAnswerButton');
//let refresh = document.querySelector('#tryAgainButton');
let playAgain = document.querySelector('#tryAgainButton');
